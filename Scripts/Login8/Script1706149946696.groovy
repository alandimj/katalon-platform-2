...
WebUI.click(findTestObject('Page_Master Quiz  Elearning CMS/button_Tambah                                    Question'))

WebUI.delay(0)

WebUI.takeScreenshot()

WebUI.click(findTestObject('Page_Master Quiz  Elearning CMS/Test Record/Page_Master Quiz  Elearning CMS/Level'))
